...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Wed Dec 10 15:30:53 2014
# Project:  final.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		lib/transforms.cpp moc_mainwindow.cpp \
		moc_view.cpp \
		qrc_shaders.cpp
OBJECTS       = main.o \
		mainwindow.o \
